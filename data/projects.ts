...
export const projects: Project[] = [
  ...
  },
  {
    ...
    date: "April 2026",
    features: [
      "8-Stage RAG Architecture querying PubMed, OpenAlex, ClinicalTrials.gov, and FDA in parallel",
      "Credibility scoring (relevance × recency × publication quality) before LLM context injection",
      "Agentic Copilot with Human-in-the-Loop: proactively proposes structured health-profile updates with user confirmation",
      "AES-256-GCM field-level encryption, RBAC, and audit logging for HIPAA-aware privacy",
      "Whisper STT/TTS voice interaction and emotional-distress detection",
      "Clinical trial matching by location and eligibility, PDF export"
    ]
  },
  {
    id: "veriflow-ai",
    ...
    date: "June 2026",
    features: [
      "4-agent pipeline: DocumentAgent → RagAgent → ComplianceAgent → ReportAgent",
      "DocumentAgent handles PDF parsing and structured extraction of SAP change request forms",
      "RagAgent performs vector similarity retrieval with chunking tuned to regulatory document structure",
      "ComplianceAgent uses chain-of-thought reasoning for PASS/FAIL/WARNING verdicts",
      "ReportAgent generates a fully scored, human-readable compliance report",
      "Automatic LLM fallback with exponential back-off and explicit error propagation",
      "Persistent rule-library storage in MongoDB eliminates re-upload overhead between audit runs"
    ]
  },
  {
    id: "pathai-platform",
    ...
    date: "Nov 2025",
    features: [
      "Built a scalable full-stack platform delivering personalized learning paths using LLM integration and user behavior analysis",
      "Developed RESTful APIs with secure authentication and role-based access control for managing users, learning workflows, and job data",
      "Implemented a job aggregation system using web scraping to fetch and recommend relevant job opportunities",
      "Designed and optimized PostgreSQL database schemas for efficient handling of user progress, skills, and recommendations",
      "Engineered a validation system enabling expert ratings and recommendations to enhance user credibility in hiring"
    ]
  },
  {
